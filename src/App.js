...
function Dashboard({ setModalOpen, collapsed, setCollapsed }) {
  const barData = {
    ...
    <Router>
      <div className="container">
        ...
        <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
          ...
          <nav>
            <ul>
              <li>
                <FaHome />
                {!collapsed && <Link to="/" className="nav-link">Home</Link>}
              </li>
              <li>
                <FaTags />
                {!collapsed && <Link to="/labels" className="nav-link">Labels</Link>}
              </li>
              <li>
                <FaChartBar />
        ...
        <Routes>
          <Route
            path="/"
            element={<Dashboard modalOpen={modalOpen} setModalOpen={setModalOpen} collapsed={collapsed} setCollapsed={setCollapsed} />}
          />
